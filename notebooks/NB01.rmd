...
Here, we see that the best n = 2 variable model uses predictors cp and ca for a misclassification rate of 25%. This corresponds to the traingle (n=2 models) that is red, or the 10th step.
...
This time, we must trade-off more false positives to make sure we get true positives and prevent more disease.
...
Unlike with the logit, we don't face nearly as steep a trade-off with false positives.
