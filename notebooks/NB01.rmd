...
formulas = c(paste(as.character(preds[1:2]), collapse = " + "),
                                           paste(as.character(preds[1:4]), collapse = " + "),
                                           paste(as.character(preds[1:8]), collapse = " + "),
                                           paste(as.character(preds[1:12]), collapse = " + "))
formulas <- paste("y ~", formulas)
...
**Look at the Plot**
```{r}
plot_grid(rf_output$results, val_measure = "misclass_rate", tp1 = "mtry", tp2 = "thresh")
```
```{r}
